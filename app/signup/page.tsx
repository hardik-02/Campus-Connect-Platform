      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-2">Create your account and join now</p>
          </div>
        </div>
        ...
        <Card className="border-border/40 shadow-lg bg-card/50 backdrop-blur">
          <CardHeader className="space-y-2">
            ...
            <CardDescription>Join thousands of students collaborating on projects</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="px-2 bg-card/50 text-muted-foreground">Already a member?</span>
              </div>
            </div>
